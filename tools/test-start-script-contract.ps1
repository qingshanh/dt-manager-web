...
Assert-Match 'Test-StaleRuntimeManifest' "stale manifest detection before recovery"
Assert-Match 'Recover-StaleRuntimeManifestServices' "verified legacy recovery for stale manifests"
Assert-Match 'Find-LegacyRuntimeService' "stale manifest recovery verifies current port owners"
